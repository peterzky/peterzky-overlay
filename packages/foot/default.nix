{ stdenv, lib, fetchgit, fcft, freetype, pixman, libxkbcommon, fontconfig
, wayland, meson, ninja, ncurses, scdoc, tllist, wayland-protocols, pkg-config
}:
...
stdenv.mkDerivation rec {
  ...
  buildInputs = [ fontconfig freetype pixman wayland libxkbcommon fcft ];
